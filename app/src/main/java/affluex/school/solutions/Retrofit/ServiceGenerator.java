...
import affluex.school.solutions.common.AppConfig;
...
public class ServiceGenerator {
    ...
    private static Retrofit.Builder builderFile = new Retrofit.Builder().baseUrl(affluex.school.solutions.BuildConfig.BASE_URL).addConverterFactory(GsonConverterFactory.create(gson));
    ...
    private static <S> S createService(Class<S> serviceClass, String username, String password) {
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl(affluex.school.solutions.BuildConfig.BASE_URL)
