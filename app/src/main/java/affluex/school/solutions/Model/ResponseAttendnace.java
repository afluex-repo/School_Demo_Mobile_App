...
public class ResponseAttendnace {
    ...
    @Expose
    private ArrayList<ModelAttendance> listAttenndace;
    ...
    public ArrayList<ModelAttendance> getListAttenndace() {
        return listAttenndace;
    }

    public void setListAttenndace(ArrayList<ModelAttendance> listAttenndace) {
