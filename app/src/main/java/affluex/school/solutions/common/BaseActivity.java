...
import static affluex.school.solutions.common.AppConfig.PAYLOAD_BUNDLE;
...
public class BaseActivity extends AppCompatActivity implements
    ...
    public void goToActivity(Activity activity, Class<?> classActivity, Bundle bundle) {
        ...
        activity.overridePendingTransition(affluex.school.solutions.R.anim.fade_out, R.anim.fade_in);
        if (bundle != null)
    ...
    public void requestAudioVideoStateContactPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_PHONE_STATE)
            ...
            Utils.createSimpleDialog1(context, "", "", "", new Utils.Method() {
                @Override
                public void execute() {
...
//        parent.addProperty("user_id", Utils.getAndroidDeviceId(context));
